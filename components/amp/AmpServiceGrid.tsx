...
// NOTE: Using native <a> tags for AMP to avoid Next.js client-side routing conflicts.
// This is critical for preventing the 'white screen' and lag issues on mobile.
...
const services = [
    {
        ...
        // AMP URLs must be absolute or relative. Since we are in AMP mode, we link to the *AMP* version of the service?
        // OR the canonical?
        // Discussion: Usually AMP listing links to AMP details.
        // The user wants a full AMP experience. So linking to `/amp/servicios/...` is correct.
        href: "/amp/servicios/restauracion-sofas"
    },
    {
        ...
        href: "/amp/servicios/tapizado-sillas"
    },
    {
        ...
        href: "/amp/servicios/cabeceros-medida"
    },
    {
        ...
        href: "/amp/servicios/muebles-exterior"
    },
];

export function AmpServiceGrid() {
    return (
            ...
            <div className="container px-4 md:px-6 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {services.map((service, index) => (
                        <a key={index} href={service.href} className="block group">
