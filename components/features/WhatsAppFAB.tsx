        ...
        <AnimatePresence>
            {isVisible && (
                <motion.a
                    ...
                    whileTap={{ scale: 0.9 }}
                    className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-[#1a8c4a] text-white rounded-full shadow-2xl hover:bg-[#0f6b38] transition-colors"
